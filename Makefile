...
SOURCES = \
	__init__.py \
	join_tables.py join_tables_dialog.py

PLUGINNAME = join_tables

PY_FILES = \
	__init__.py \
	join_tables.py join_tables_dialog.py

UI_FILES = join_tables_dialog_base.ui
...
QGISDIR=E:\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
